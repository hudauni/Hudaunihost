...
export default function TaskDetailPage() {
  ...
  const fetchVideosAndProgress = useCallback(async () => {
    ...
    try {
      ...
      // 3. Fetch user progress using unique UID
      ...
      <main className="flex-1 w-full max-w-6xl mx-auto px-6 py-8 lg:pt-[100px]">
        <div className="flex items-center space-x-4 mb-8">
          ...
          <div>
            ...
            <p className="text-emerald-500/60 text-sm font-medium uppercase tracking-wider">Level: {levelId} • Task {taskId}</p>
          </div>
        </div>
